...
Les résidus ne sont clairement pas distributés uniformément sur le second graphique et la surdipersion est évidente sur le 3e graphique.
...
En général, une sous-dispersion ignorée fera en sorte que l'incertitude sera surestimée (trop conservateurs dans nos résultats) ce qui est un peu moins grave.
...
Solutions: modèle *zero-inflated* (`glmmTMB`,`pscl`,`brms`, etc.)
...
g<-gam(y~s(x),data=d) # le s veut dire smooth de x
